	...
	Storei Rx, Ry
			...
			free(str_tmp2);
                ...
                */
                ...
                case ADDINTTOASCII_CODE :  // Add R1, R2, R3
                    str_tmp1 = parser_GetItem_s(); /* ADD sem carry */
                    val1 = BuscaRegistrador(str_tmp1);
                    free(str_tmp1);
                    parser_Match(',');
                    ...
                    str_tmp2 = ConverteRegistrador(val2);
                    str_tmp3 = ConverteRegistrador(val3);
                    sprintf(str_msg,"%s%s%s%s0",ADDINTTOASCII,str_tmp1,str_tmp2,str_tmp3);
                    free(str_tmp1);
                    free(str_tmp2);
                    free(str_tmp3);
                    parser_Write_Inst(str_msg,end_cnt);
...
int BuscaInstrucao(char * nome)
{
    ...
    */
    ...
    else if (strcmp(str_tmp, ADDINTTOASCII_STR) == 0)
    {
        return ADDINTTOASCII_CODE;
    }
